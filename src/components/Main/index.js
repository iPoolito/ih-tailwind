    ...
    <>
      <div className="max-w-7xl mx-auto px-12 pt-12">
        <form
          ...
          className={editionMode ? 'p-10 bg-yellow-100' : null}
        >
        ...
        <h1 class="text-4xl font-extrabold text-gray-900 mt-12 sm:text-5xl sm:tracking-tight lg:text-6xl">
          Publicaciones
        </h1>
                ...
                return (
                  <>
                    <li class="bg-white py-5 px-4 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      ...
                      <div class="mt-1">
                        <p class="line-clamp-2 text-sm text-gray-600">{e.contenido}</p>
                      </div>
